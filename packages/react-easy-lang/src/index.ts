...
// 创建react翻译工具
export function createReactI18nTool<T extends Record<string, Record<string, string>>, L extends string>(i18n: ReturnType<typeof createI18nTool<T, L>>) {
    const { $t: _$t, changeLang: _changeLang, getCurrentLang, untranslatedList, langs, defaultLang } = i18n

    type Lang = typeof langs[number]
    // 生成新的
    const memoizedT = (currentLang: Lang) => useCallback(() => {
